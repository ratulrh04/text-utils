...
const[mood, setMood]=useState('Enable Dark Mood')
 ...
 let colorToggleBtn = ()=>{
    ...
    return (
        ...
        <div className="accordion accordion-flush" id="accordionFlushExample"  style={myStyle}>
             <h1 style={{textAlign : 'center' , fontStyle : 'italic'}}> About Heading </h1>
       ...
       <button className=" btn btn-primary" onClick={colorToggleBtn}> {mood}</button>
    </div>
        </div>
           </div>
        </div>
